...
<head>
  ...
  <title>Portfolio - Nandan Nandaniya</title>
...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>Nandan B. Nandaniya</h1>
      <h2>I'm a Developer & Designer</h2>
          ...
          <div class="col-lg-8 d-flex flex-column align-items-stretch">
            <div class="content ps-lg-4 d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-lg-6">
                  <ul>
                    <li><i class="bi bi-chevron-right"></i> <strong>Name:</strong> <span>Nandan Bhupatbhai Nandaniya</span></li>
              ...
              <div class="row mt-n4">
                <div class="col-md-12 mt-5 d-md-flex align-items-md-stretch">
                  <div class="count-box">
                    <!-- <p style="text-align: left;letter-spacing: 3px;">Hello, I am Nandan Nandaniya From Jamnagar. I am Future Developer &amp; Designer. I am currently pursuing B.VOC-IT in Rk University at Institute of quality education.I Have Complete SSC &AMP; HSC In Shree D.S. Gojiya Vidhyalay-Jamnagar. I am Usually Flexible to Learning New things.
                    </p> -->
                    <p style="text-align: left;letter-spacing: 3px;">Hiiii, I am Nandan Nandaniya From Jamnagar.I am Developer & Designer. I am currently pursuing B.VOC - IT in Rk University.I am currently Working in Rk Infotech as a PHP Developer.</p>
                    <p style="text-align: left;letter-spacing: 3px;">I am currently doing college, so for I have learned a lot and there is a lot to learn, to get an opportunity that allows me to showcase my skills and contribute to the company's growth. </p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              ...
              <h5>2023 - Present</h5>
              <p><em>Rk Infotech -Rajkot </em></p>
              <p>
              <ul>
                <li>Rk Infotech is a product-based company. And I work on Codeigniter.</li>
                <li>I work there on the company's product DelightERP. </li>
                <li>I also work on a project called Erigomoney, outdoor, ssassociation.</li>
              </ul>
              </p>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex flex-column align-items-stretch">
            ...
            <div class="skills-content ps-lg-4">
              ...
              <div class="progress">
                <span class="skill">PHP <i class="val">72%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">JavaScript,JQuery,Ajax <i class="val">65%</i></span>
                <div class="progress-bar-wrap">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>Email Me</h3>
                  <p>nandannandaniya08@gmail.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4">
